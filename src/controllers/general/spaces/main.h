...
#include "controllers/general/spaces/users.h"
...
class StructBX::Controllers::General::Spaces::Main : public Tools::FunctionData
{
    public:
    ...
    private:
        General::Spaces::Users function_users_;
        Read struct_read_;
